...
class Combat
{
	public:
		...
		static void doCombatShield(Creature* caster, Creature* target,
			int32_t minChange, int32_t maxChange, const CombatParams& params, bool check = true);
		static void doCombatShield(Creature* caster, const Position& pos,
			const CombatArea* area, int32_t minChange, int32_t maxChange, const CombatParams& params);
	...
	protected:
		...
		static bool CombatShieldFunc(Creature* caster, Creature* target, const CombatParams& params, void* data);
