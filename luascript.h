...
class LuaInterface
{
	...
	protected:
		...
		static int32_t luaDoCreatureAddShield(lua_State* L);
		static int32_t luaDoCreatureAddBarrier(lua_State* L);
		...
		static int32_t luaSetCreatureMaxShield(lua_State* L);
		static int32_t luaSetCreatureMaxBarrier(lua_State* L);
		...
		static int32_t luaGoTo(lua_State* L);
		static int32_t luaCanGoTo(lua_State* L);		
		...
		static int32_t luaGetHouseTiles(lua_State* L);
		...
		static int32_t luaIsWalking(lua_State* L);		
		...
		static int32_t luaGetCreatureShield(lua_State* L);
		static int32_t luaGetCreatureMaxShield(lua_State* L);
		static int32_t luaGetCreatureBarrier(lua_State* L);
		static int32_t luaGetCreatureMaxBarrier(lua_State* L);
