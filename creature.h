...
class Creature : public AutoId, virtual public Thing
{
	...
	public:
		...
		virtual int32_t getShield() const {return shield;}
		virtual int32_t getMaxShield() const {return shieldMax;}
		virtual int32_t getBarrier() const {return barrier;}
		virtual int32_t getMaxBarrier() const {return barrierMax;}
		...
		virtual void changeShield(int32_t shieldChange);
		void changeMaxShield(uint32_t shieldChange) {shieldMax = shieldChange;}
		virtual void changeBarrier(int32_t barrierChange);
		...
		virtual void setPShield(PartyShields_t newPartyShield) {partyShield = newPartyShield;}
		virtual PartyShields_t getPShield() const {return partyShield;}
		virtual PartyShields_t getPartyShield(const Creature* creature) const {return creature->getPShield();}
	...
	protected:
		...
		int32_t shield, shieldMax;
		int32_t barrier, barrierMax;
