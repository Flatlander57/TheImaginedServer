...
#define	SLOTP_RING2 (1 << 10)
#define	SLOTP_BELT (1 << 11)
#define	SLOTP_DEPOT (1 << 12)
#define	SLOTP_TWO_HAND (1 << 13)
#define SLOTP_HAND (SLOTP_LEFT | SLOTP_RIGHT)
#define SLOTP_FINGERS (SLOTP_RING | SLOTP_RING2)
...
struct Abilities
{
	Abilities()
	{
		...
		speed = healthGain = healthTicks = manaGain = manaTicks = shieldGain = shieldTicks = elementDamage = conditionSuppressions = 0;
	};
	...
	int32_t skills[SKILL_LAST + 1], skillsPercent[SKILL_LAST + 1], stats[STAT_LAST + 1], statsPercent[STAT_LAST + 1],
		speed, healthGain, healthTicks, manaGain, manaTicks, shieldGain, shieldTicks, conditionSuppressions;
};
