...
class ProtocolGame : public Protocol
{
	...
	private:
		...
		void sendCreatureBarrier(const Creature* creature);
		void sendSkills();
		void sendPing();
		void sendPingBack();
		...
		void AddCreatureShield(NetworkMessage_ptr msg, const Creature* creature);
		void AddCreatureBarrier(NetworkMessage_ptr msg, const Creature* creature);
